...
paths <- list.files("~/Music/olympus-ls12-misc/2111", full.names = TRUE)
paths
...
predictions_b <- predict_species_from_audio_file(model, "~/Music/olympus-ls12-misc/2111/211106_0447.wav", filter_species = sl_birds)
